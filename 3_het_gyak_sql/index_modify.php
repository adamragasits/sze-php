...
if (isset($_POST['uj_feladat']) && !empty($_POST['feladat_szoveg'])) {
    ...
    // prepared statement
    $stmt = mysqli_prepare($conn, "INSERT INTO todo (teendo, feltoltes_idopontja) VALUES (?, ?)");
    mysqli_stmt_bind_param($stmt, "ss", $feladat, $datum);
...
// print_r(mysqli_fetch_all($eredmeny));
?>
